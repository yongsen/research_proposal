...
\markboth{R\MakeLowercase{esearch} P\MakeLowercase{roposal for} P\MakeLowercase{h}D A\MakeLowercase{pplication of} ECE, HKUST}{Yongsen MA}
% make the title area
\maketitle
